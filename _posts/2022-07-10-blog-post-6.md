...
But we want represent our points (documents) by minimum number of dimension (topics). So, if we remove the $\hat k$ component the red point then this point can also be represented in two dimension where other points also lie.   
